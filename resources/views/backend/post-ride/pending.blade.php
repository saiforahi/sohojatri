                    ...
                    @foreach ($ride as $rides)
                        <tr>
                            <td>
                                ...
                                <p class="my-0 fs-12 lh-1-2">
                                    Create: {{date("l F-d. h:i A", strtotime($rides->created_at))}}</p>
                                ...
                                <p class="my-0 fs-12 lh-1-2">Car number
                                    plate: {{getCarById($rides->car_id, 'number_plate')}}</p>
                            ...
                            <td>
                                <a href="{{route('admin.pending.post').'/'.$rides->id}}"
                                   class="btn btn-sm btn-success my-1 fs-6">View
                                    ride</a>
                            </td>
                        </tr>
